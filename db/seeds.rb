...
Car.create([{make: 'bmw', model: 'M2', engine_size: 2, user: user, finance_provider: finance_provider}, {make: 'audi', model: 'A6', engine_size: 4, user: user, finance_provider: finance_provider}, {make: 'Mercades', model: 'C250', engine_size: 2.2, user: user, finance_provider: finance_provider}, {make: 'bmw', model: 'M4', engine_size: 4, user: user, finance_provider: finance_provider}, {make: 'bmw', model: 'M2', engine_size: 2, user: user, finance_provider: finance_provider}])
